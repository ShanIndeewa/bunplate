...
const CompanyTabs = [
  { name: "My Summery", href: "/account/manage" },
  { name: "My Jobs", href: "/account/manage/apply-jobs" },
  { name: "My Profile", href: "/account/manage/profile-details" },
];

export function UserTabBar({}: Props) {
